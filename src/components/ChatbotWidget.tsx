...
const ChatbotWidget = () => {
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      {open && (
        <div className="mb-3 w-[360px] max-w-[calc(100vw-2rem)] h-[520px] flex flex-col rounded-2xl bg-card shadow-2xl border border-border overflow-hidden animate-in fade-in slide-in-from-bottom-4">
