...
const HeroEstimator = () => {
  ...
  return (
    <div className="bg-card text-card-foreground rounded-2xl shadow-2xl border border-border p-6 lg:p-8 w-full max-w-lg lg:max-w-none">
      ...
      <div className="space-y-5">
        ...
        <div>
          ...
          <Slider
            ...
            className="py-2 [&_[data-orientation=horizontal]]:h-3.5 [&_[role=slider]]:h-9 [&_[role=slider]]:w-9 [&_[role=slider]]:border-[3px] [&_[role=slider]]:shadow-lg"
          />
